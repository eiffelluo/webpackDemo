...
class Tip extends React.Component {
    ...
    componentDidMount() {
        ...
        document.addEventListener('click', this.hideByArea);
    }
    ...
    hideByArea = (event) => {
        ...
        console.log('event.nativeEvent.clientX', event.clientX)
        console.log('event.nativeEvent.clientY', event.clientY)
    }
                    ...
                    ReactDOM.createPortal(
                        <div style={{ position: 'relative', visibility: this.state.flag ? 'visible' : 'hidden' }}>
                            <div ref={(e) => { this.send = e }}
                                ...
                                {typeof this.props.title === 'function' ? this.props.title(context) : this.props.title}
